    ...
    <div class="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 z-20">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center animate-float">
                ...
                <h2 class="text-4xl font-bold text-white text-glow mb-2">Welcome Back</h2>
                <p class="text-white/80 text-lg">Sign in to your FotoIn account</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" class="mt-8 space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input 
                                    ...
                                    name="remember" 
                                    type="checkbox" 
                                    class="h-4 w-4 text-white/60 focus:ring-white/50 border-white/30 rounded bg-white/10"
                                >
                        ...
                        <div>
                            ...
                            >
                                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <i class="fas fa-sign-in-alt text-white/60 group-hover:text-white/80"></i>
                                </span>
                                Sign in
                            </button>
                        </div>
                ...
                <div class="text-center">
                    <p class="text-white/80">
                        Belum punya akun? 
                        <a href="{{ route('user.register') }}" class="font-medium text-white hover:text-white/80 transition-colors underline decoration-white/50 hover:decoration-white">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
